                ...
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="index-11.htm">
                            <span itemprop="name">{{__('Site\showProduct.home')}}</span>
                        </a>
    ...
    <div class="container no-index">
        <div class="row">
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    <h1 class="page-title">{{__('Site\showProduct.Payment Methods')}}</h1>
                    <div class="cart-grid row">
                        <form class="needs-validation" method="post" action="{{route('payment.process')}}" novalidate="">
                                @csrf
                            <hr class="mb-4">
                            <h4 class="mb-3">{{__('Site\showProduct.Payment')}}</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="cc-name"> {{__('Site\showProduct.Name on card')}}</label>
                                    <input type="text" class="form-control" id="cc-name" placeholder="" required="">
                                    <small class="text-muted">{{__('Site\showProduct.Full name as displayed on card')}}</small>
                                    <div class="invalid-feedback">

                                        {{__('Site\showProduct.Name on card is required')}}
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cc-number" >{{__('Site\showProduct.Credit card number')}}</label>
                                    <input type="text" class="form-control" name="ccNum" id="cc-number" placeholder="" required="">
                                    <div class="invalid-feedback">
                                        {{__('Site\showProduct.Credit card number is required')}}
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <label for="cc-expiration"> {{__('Site\showProduct.Expiration')}}</label>
                                    <input type="text" class="form-control" name="ccExp" id="cc-expiration" placeholder="" required="">
                                    <div class="invalid-feedback">

                                        {{__('Site\showProduct.Expiration date required')}}
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="invalid-feedback">
                                        ...
                                        {{__('Site\showProduct.Security code required')}}
                                    </div>
                                </div>
                            </div>
                            <hr class="mb-4">
                            <button class="btn btn-primary btn-lg btn-block" type="submit"> {{__('Site\showProduct.Continue to checkout')}}</button>
                        </form>
                    </div>
                </section>
            </div>
