    ...
    <div class="container no-index">
        <div class="row">
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    <h1 class="page-title">{{__('Site\showProduct.Shopping Cart')}}</h1>
                    <div class="cart-grid row">
                        <div class="cart-grid-body col-xs-12 col-lg-9">
                                                                        ...
                                                                        <div class="col-sm-9 col-xs-12">
                                                                            <div class="row">
                                                                                <div class="col-md-6 col-xs-6 qty">
                                                                                    <div
                                                                                        class="label">{{__('Site\showProduct.Qty')}}
                                                                                        :
                                                                                    </div>
                                                                                    <div
                            ...
                            <a class="label btn btn-primary" href="http://demo.bestprestashoptheme.com/savemart/en/">
                                {{__('Site\showProduct.Continue shopping')}}
                            </a>
                            ...
                            <div class="cart-summary">
                                <div class="cart-detailed-totals">
                                    <div class="cart-summary-products">
                                        <div class="summary-label"> {{__('Site\showProduct.There are')}}
                                            ({{$basket -> itemCount()}})
                                            {{__('Site\showProduct.items in your cart')}}
                                        </div>
                                    </div>

                                    <div class="">
                                        <div class="cart-summary-line cart-total">
                                            <span class="label">{{__('Site\showProduct.Total')}}:</span>
                                ...
                                <div class="checkout text-xs-center card-block">
                                    <a href="{{route('payment',$basket -> subTotal())}}" type="button"
                                       class="btn btn-primary">
                                        {{__('Site\showProduct.proceed to payment')}}
                                    </a>
                                </div>
            ...
            <span class="item-product">
                                    ...
                                    {{__('Site\showProduct.Security policy (edit with Customer reassurance module)')}}</p>
                                </div>
                                 <div>
            <span class="item-product">
                                                          <img class="svg invisible"
                                    ...
                                    <p class="block-title" style="color:#000000;">
                                        {{__('Site\showProduct.Delivery policy (edit with Customer reassurance module)')}}
                                       </p>
                                </div>
                                <div>
            <span class="item-product">
                                    ...
                                    <p class="block-title" style="color:#000000;">
                                        {{__('Site\showProduct.Return policy (edit with Customer reassurance module)')}}
                                       </p>
                                </div>
...
@stop
{{__('Site\showProduct.remove-from-cart')}}
