    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close"  data-product-id="{{$product -> id}}" data-dismiss="modal" aria-label="Close"><i class="material-icons close">
                        {{__('Site\showProduct.close')}}
                        </i></button>
            </div>
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div class="product-prices">
                            ...
                            <div class="tax-shipping-delivery-label">
                                 {{__('Site\showProduct.Tax included')}}
                            </div>
                        </div>
                                 ...
                                 <div class="product-add-to-cart in_border">
                                    <div class="add">
                                        <button class="btn btn-primary add-to-cart" data-button-action="add-to-cart" type="submit">
                                            ...
                                            <span> {{__('Site\showProduct.Add to cart')}}</span>
                                        </button>
                                    </div>
                                    ...
                                    <div id="product-availability" class="info-stock mt-20">
                                        <label class="control-label">{{__('Site\showProduct.Availability')}}:</label>
                        ...
                        <div class="dropdown social-sharing">
                            <button class="btn btn-link" type="button" id="social-sharingButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span><i class="fa fa-share-alt" aria-hidden="true"></i>{{__('Site\showProduct.Share With')}}:</span>
                            </button>
