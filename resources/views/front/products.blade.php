...
@section('content')
                            ...
                            <div id="js-product-list-top" class="row products-selection">
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <div class="hidden-sm-down total-products">
                                        <p>{{__('Site\showProduct.There are')}} {{count($products) ?? '0'}} {{__('Site\showProduct.products')}}
                                            .</p>
                                                ...
                                                <div class="product-miniature js-product-miniature item-one"
                                                    ...
                                                    <div class="product-description">
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="group-reviews">
                                                                ...
                                                                <div class="info-stock ml-auto">
                                                                    <label
                                                                        class="control-label"> {{__('Site\showProduct.Availability')}}
                                                                        :</label>
                                                                    <i class="fa fa-check-square-o"
                                                                       aria-hidden="true"></i>
                                                                    {{$product -> in_stock ? __('Site\showProduct.in stock'): __('Site\showProduct.out of stock')}}
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            <form class="formAddToCart" action="post">
                                                                ...
                                                                <a class="add-to-cart cart-addition"
                                                                   ...
                                                                   data-button-action="add-to-cart"><i
                                                                        class="novicon-cart"></i><span> {{('Site\showProduct.Add to cart')}}</span></a>
                                                            </form>

                                                            <a class="addToWishlist  wishlistProd_22" href="#"
                                                               data-product-id="{{$product -> id}}">
                                                                <i class="fa fa-heart"></i>
                                                                <span> {{('Site\showProduct.Add to Wishlist')}}</span>
                                                            </a>
    ...
    <div class="modal fade in alert-cart-modal" style="display: none; padding-right: 17px;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="material-icons close">{{__('Site\showProduct.close')}} </i>
                    </button>
                </div>
                <div class="modal-body"></div>
                <div class="modal-body">{{__('Site\showProduct.the product added to cart successfully')}} .</div>
            </div>
        </div>
    </div>
    <div class="modal fade in alert-cart-modal2" style="display: none; padding-right: 17px;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body"></div>
                <div class="modal-body">{{__('Site\showProduct.the product failed to add cart')}} .</div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.close', function () {
            ...
            $('.alert-cart-modal').css('display','none');
            $('.alert-cart-modal2').css('display','none');
        });
        $.ajaxSetup({
            headers: {
