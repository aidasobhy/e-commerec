                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('Admin\users.main')}}</a>
                                </li>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('Admin\users.operations')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                       ...
                                                       <td>{{$user -> email}}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href=""
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{__('Admin\users.edit')}} </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
